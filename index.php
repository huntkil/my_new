  ...
  <div class="max-w-4xl mx-auto space-y-12">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <a href="./modules/tools/box/boxbreathe.php" class="group">
        <div class="bg-card text-card-foreground rounded-lg border p-6 space-y-4 hover:border-primary transition-colors">
          ...
          <p class="text-muted-foreground">Explore our box breathing guide</p>
        </div>
      </a>
    ...
    <section class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Hosting Index File -->
        <div class="bg-card text-card-foreground rounded-lg border shadow-sm p-6 space-y-4 ' . (!isset($_SESSION['id']) ? 'opacity-50' : '') . '">
          <div class="flex items-center gap-2">
