        ...
        <div class="max-w-5xl mx-auto space-y-8">
            <?php if (isset($error_message)): ?>
                <div class="bg-red-50 border border-red-200 rounded-xl p-6 shadow-sm">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            <h3 class="font-semibold text-red-800 text-lg">오류 발생</h3>
                            <p class="mt-2 text-red-700"><?php echo htmlspecialchars($error_message); ?></p>
                            <a href="search_news_form.php" class="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium">
            ...
            <?php elseif (!empty($newsData->articles)): ?>
                <?php if (isset($isDemo) && $isDemo): ?>
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6 shadow-sm">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                <h3 class="font-semibold text-blue-800 text-lg">📰 데모 모드</h3>
                                <p class="mt-2 text-blue-700">
                                    News API 키가 설정되지 않아 샘플 데이터를 표시합니다. 
                                    실제 뉴스 데이터를 보려면 <a href="https://newsapi.org/register" target="_blank" class="underline font-medium hover:text-blue-800">News API</a>에서 무료 API 키를 받아 config.php에 설정하세요.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between flex-wrap gap-4">
                        <div class="flex-1">
                            <h1 class="text-3xl font-bold text-gray-900 mb-2">
                                <?php if ($action == '전체 기사'): ?>
                                    🌍 전체 기사 <span class="text-blue-600">(<?php echo strtoupper($country); ?>)</span>
                                <?php else: ?>
                                    🔍 검색 결과: <span class="text-blue-600">"<?php echo htmlspecialchars($query); ?>"</span>
                                <?php endif; ?>
                                <?php if (isset($isDemo) && $isDemo): ?>
                        ...
                        <a href="search_news_form.php" 
                           class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 font-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
                            </svg>
                            새로운 검색
                ...
                <div class="grid gap-6 md:gap-8">
                    ...
                    ?>
                        <article class="group bg-white rounded-xl shadow-sm hover:shadow-lg border border-gray-200 overflow-hidden transition-all duration-300 transform hover:scale-[1.02] <?php echo $isFirstArticle ? 'md:col-span-2 lg:col-span-3' : ''; ?>">
                            <?php if ($imageUrl): ?>
                                <div class="relative overflow-hidden <?php echo $isFirstArticle ? 'h-64 md:h-80' : 'h-48'; ?>">
                            ...
                            <div class="p-6 space-y-4">
                                <div class="space-y-3">
                                    <h2 class="text-xl <?php echo $isFirstArticle ? 'md:text-2xl lg:text-3xl' : ''; ?> font-bold text-gray-900 leading-tight group-hover:text-blue-600 transition-colors duration-200">
                                        <?php echo $title; ?>
                                    </h2>
                                    
                                    <?php if ($description): ?>
                                        <p class="text-gray-600 leading-relaxed <?php echo $isFirstArticle ? 'text-lg' : ''; ?>">
                                ...
                                <div class="flex items-center justify-between pt-4">
                                    <?php if ($url && $url !== '#'): ?>
                                        <a href="<?php echo $url; ?>" 
                                           ...
                                           class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-105 font-medium">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    <?php else: ?>
                                        <div class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-500 rounded-lg font-medium">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <circle cx="12" cy="12" r="10"/>
                                                <path d="M12 16v-4"/>
                                                <path d="M12 8h.01"/>
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button class="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-full transition-colors duration-200" title="좋아요">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.29 1.51 4.04 3 5.5l7 7Z"/>
                                            </svg>
                                        </button>
                                        <button class="p-2 text-gray-400 hover:text-blue-500 hover:bg-blue-50 rounded-full transition-colors duration-200" title="공유">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        <button class="p-2 text-gray-400 hover:text-green-500 hover:bg-green-50 rounded-full transition-colors duration-200" title="북마크">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex flex-col sm:flex-row items-center gap-4">
                            <div class="text-center sm:text-left">
                                <h3 class="font-semibold text-gray-900 mb-1">더 많은 뉴스를 찾고 계신가요?</h3>
                                <p class="text-sm text-gray-600">다른 검색어로 최신 뉴스를 찾아보세요</p>
                            </div>
                            <a href="search_news_form.php" 
                               class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 font-medium">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <?php else: ?>
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
                    <div class="max-w-md mx-auto space-y-6">
                        <div class="mx-auto w-20 h-20 bg-gradient-to-br from-blue-100 to-blue-200 rounded-full flex items-center justify-center">
                        ...
                        <div class="space-y-2">
                            <h2 class="text-2xl font-bold text-gray-900">검색 결과가 없습니다</h2>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 justify-center">
                            ...
                            <a href="/" 
                               class="inline-flex items-center gap-2 px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors duration-200 font-medium">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
