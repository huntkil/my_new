...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="text-center mb-12">
        <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">AI Reading Coach</h1>
        <p class="text-lg text-muted-foreground max-w-2xl mx-auto">
            속발음 문제를 해결하고 읽기 속도를 향상시키세요
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-card border rounded-lg p-6">
            ...
            <div class="space-y-3">
                <button onclick="startQuickSession()" class="w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors font-medium text-sm">
                    🚀 빠른 연습 시작
                </button>
                <button onclick="showRecommendations()" class="w-full bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 transition-colors font-medium text-sm">
                    💡 AI 추천 연습
                </button>
                <button onclick="viewProgress()" class="w-full bg-purple-600 text-white py-2 px-4 rounded-lg hover:bg-purple-700 transition-colors font-medium text-sm">
                    📊 진도 확인
                </button>
            </div>
        </div>
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                ...
                <a href="exercises/visual_reading.php" class="inline-block bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors font-medium text-sm">
                    연습 시작
                </a>
            </div>
            ...
            <div class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                ...
                <a href="exercises/rhythm_reading.php" class="inline-block bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-green-700 transition-colors font-medium text-sm">
                    연습 시작
                </a>
            </div>
            ...
            <div class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                ...
                <a href="exercises/finger_following.php" class="inline-block bg-purple-600 text-white py-2 px-4 rounded-lg hover:bg-purple-700 transition-colors font-medium text-sm">
                    연습 시작
                </a>
            </div>
            ...
            <div class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                ...
                <a href="exercises/keyword_reading.php" class="inline-block bg-orange-600 text-white py-2 px-4 rounded-lg hover:bg-orange-700 transition-colors font-medium text-sm">
                    연습 시작
                </a>
            </div>
            ...
            <div class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                ...
                <a href="exercises/lip_tongue_fixation.php" class="inline-block bg-red-600 text-white py-2 px-4 rounded-lg hover:bg-red-700 transition-colors font-medium text-sm">
                    연습 시작
                </a>
            </div>
            ...
            <div class="group bg-card border rounded-lg p-6 hover:shadow-lg transition-all duration-200 hover:scale-105">
                ...
                <a href="exercises/progressive_reading.php" class="inline-block bg-indigo-600 text-white py-2 px-4 rounded-lg hover:bg-indigo-700 transition-colors font-medium text-sm">
                    연습 시작
                </a>
            </div>
        </div>
...
function startQuickSession() {
    window.location.href = 'exercises/visual_reading.php';
}

function showRecommendations() {
    alert('AI 추천 연습 기능은 개발 중입니다.');
}

function viewProgress() {
    alert('진도 확인 기능은 개발 중입니다.');
}
</script>
