                ...
                <div class="hidden md:flex items-center gap-6">
                    <div class="flex items-center gap-1">
                        ...
                        <div id="learning-dropdown" class="absolute top-full mt-2 w-48 bg-popover border rounded-lg shadow-lg hidden">
                            ...
                            <a href="<?php echo $nav->getModuleUrl('learning/voca/voca.html'); ?>" class="block px-4 py-2 hover:bg-accent text-sm">Vocabulary</a>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <div id="tools-dropdown" class="absolute top-full mt-2 w-48 bg-popover border rounded-lg shadow-lg hidden">
                            ...
                            <a href="<?php echo $nav->getModuleUrl('tools/tour/familytour.html'); ?>" class="block px-4 py-2 hover:bg-accent text-sm">Family Tour</a>
            ...
            <nav class="p-4 space-y-4">
                <div>
                    ...
                    <div class="space-y-1 ml-4">
                        ...
                        <a href="<?php echo $nav->getModuleUrl('learning/voca/voca.html'); ?>" class="block p-2 rounded hover:bg-accent text-sm">Vocabulary</a>
                    </div>
                </div>
                <div>
                    ...
                    <div class="space-y-1 ml-4">
                        ...
                        <a href="<?php echo $nav->getModuleUrl('tools/tour/familytour.html'); ?>" class="block p-2 rounded hover:bg-accent text-sm">Family Tour</a>
